...
# Welcome
_This is my PhD in fun mode. It combine data collection, analysis, model building, narrative, and visualizations under the same roof, with a pinch of 'choose your own adventure' for people who get bored. See [my main website](https://jstonge.vercel.app/) for more details_
...
play specific roles to succeed. 
...
Institutions are inherently collective
...
Beyond social learning strategies, we are characterized by
...
experiment [@tomasello_differences_2023]. 

In experimental games, they
...
- [A short history of group minds](https://jstonge.observablehq.cloud/grontology) introduces the history of the ontological questions about groups in the social sciences, as well as how researchers are addressing these in empirical projects today.
- [Laboratory of group minds](https://jstonge.observablehq.cloud/hello-research-groups/interface) bridges the two, introducing mean-field theory, evolutionary game theory, and master equations. 
- [Defining and classifying models of groups: The social ontology of higher-order networks](https://jstonge.observablehq.cloud/hello-research-groups/chapters/chapter_1) delves into the modeling assumptions and potential empirical challenges involved in applying the typology. 
- [Paradoxes in the co-evolution of contagions and institutions](https://jstonge.observablehq.cloud/hello-research-groups/coevo)presents a group-based model of the co-evolution between contagion and institutions, demonstrating a paradox: stronger epidemics can lead to smaller outbreaks when institutions respond effectively. 
- [Computational hysteresis in the social sciences](https://jstonge.observablehq.cloud/hello-research-groups/groupSkills) introduces a group-based model of skill acquisition within research groups, where the cost–benefit trade-offs of learning new skills differ between the individual and group levels. We use the case of programming in the humanities as an illustrative example, highlighting how various pressures can create bistability in the adoption of new skills. 
