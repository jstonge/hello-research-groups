...
def main():
    ...
    for code in tqdm(state_code[1:], total=len(state_code[1:])):
        ...
        for yr in range(1960, 2023):
            table_dat = []
            print(yr)
            url=f"https://apps.neh.gov/PublicQuery/Default.aspx?q=1&a=0&n=0&o=0&ot=0&k=0&f=0&s=1&sv={code}&cd=0&p=0&d=0&at=1&atv=2&y=1&yf={yr}&yt={yr+1}&prd=0&cov=0&prz=0&wp=0&sp=0&ca=0&arp=0&ob=Institution%20name&or=ASC"
