...
In this notebook, our goal is to relate core assumptions from philosophy, physics of HONs, and cultural evolution about non-reducible groups.

<div class="note" label="Grontology paper - guideline">
  <small>
      <ul>
...
<div class="grid grid-cols-2">
  ...
  A separate, but closely related philosophy inquiry, is that of collective intentionality; the "aboutness" of groups. If group exist and they can take actions, in ways that are irreducible to its constituents, what does it say about the intent of groups. From this line of thoughts stems questions about corporate responsibility (French 1984), rationality (Gilbert 2006), and the epistemic stance of groups (Lackey 22021). 
  ...
  Philosophers are not alone in rejecting methological individualism. In the physics of higher-order networks (HONs), most researchers seek to quantify the conditions under which higer-order interactions are more than the sum of pairwise interactions. That being said, physicists are not ontologically committed; they rarely take position on the ontological states of groups.
  
  Cultural evolutionists argue that group dynamics, such as intergroup competition, is key to understand the emergence of cooperative norms that drive large-scale collaboration among unrelated individuals (cite Bowles; Boyd & Richerson 2023). Cultural evolutionists discussed at length the reality of groups with respect of units of selection.

  Although philosophers, physicists, and cultural evolutionists adopt similar stance about emergent "group stuff", they differ significantly in their attitudes and methods. In this paper, we seek to initiate a dialogue among these three communities regarding the benefits espousing group-level attributes. We ground the dialogue in group-based formalism, 
  
<ul class="card task-list">
  todo<br><br>
  <li><input type="checkbox"><em>Context</em>: Social scientists, evolutionists, philosophers all tried very hard to pin down the meaning of non-reducible groups. All those efforts have been controversial on their own turf.</li>
  <li><input type="checkbox"><em>Context</em>: Social ontology of social groups is about what we mean when we say that we form groups. As philosophers, they are the experts on ontological questions. Yet, should they be allowed to be totally unconstrained from modeling works on groups?</li>
  <li><input type="checkbox"><em>Context</em>: Cultural group selection (CGS) also talk about the meaning of groups, but include the discussion units of adaptation. Tim's claim they bring the idea of causal mechanisms and functional and structural differences (which ones?) that we can use to create a typology of groups. But the works to tie all of this to the philosophy of groups and higher-order networks remain to be done</li>
</ul>

  ## II. A brief history of groups taking group stuff seriously
