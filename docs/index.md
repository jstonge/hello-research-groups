...
Complex scientists are interested in how components of complex systems interact in non-trivial ways, giving rise to tipping points, emergence, and more generally collective phenomena. By using all sorts of models, it is possible to study a variety of systems under the same umbrella. Yet, in the face of complexity, we observe a common trend. 

Complex scientists tend to assume that the fundamental unit of human-scale natural systems are individuals. By that, we mean that the first, most commonsensical modeling step, involve a single member of a class. In this set of notebook, as ask whether this is a warranted assumption in most cases of human social systems. 

What if the most intuitive first step in modeling is to focus on the group level? On the one hand, sociologists, anthropologists, and organizational scientists have been interested for a long time in how social groups might be the essential units of human behaviors. But as far as I can tell they mostly lack mechanistic models formalizing what they mean when they say groups act as entities. We justify this claim furter in [this notebook](https://jstonge.observablehq.cloud/hello-research-groups/grontology). On

 the other end, the original complex scientists were physicists modeling social systems as particle-like systems. More recently, they started to model group. But, as we will show, they often ignore previous work in the qualitative social science and philosophy that has been done on groups (but see ...).
...
## Empirical challenges [FUTURE WORK]
...
_The rise of computational works [FUTURE WORK]_
...
_Epistemic inequality [FUTURE WORK]_
...
_Group ontology [Paper: in progress]_
...
_Computational hysteresis in the social sciences [Paper: in progress]_
...
### Models 
_Group-based models [Paper: in progress]_
